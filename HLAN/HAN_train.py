...
import   data_loading
import   prediction
import   session_creation
import   training
import  validation

from HAN_model_dynamic import HA_GRU, HAN, HLAN
from performance import ModelOutputs, SummaryPerformance
...
def process_options(
    ...
    logger.debug(f"Training on {[path for path in dataset_paths]}")
    print(dataset_paths)
...
def main(
    ...
    if dataset == 'mimic-50':
        dataset_paths = ['caml-mimic/mimicdata/mimic3/dev_50.csv',
                         'caml-mimic/mimicdata/mimic3/train_50.csv',
                         'caml-mimic/mimicdata/mimic3/test_50.csv']
    elif dataset == 'mimic':
        dataset_paths = ['caml-mimic/mimicdata/mimic3/dev_full.csv',
                         'caml-mimic/mimicdata/mimic3/train_full.csv',
                         'caml-mimic/mimicdata/mimic3/test_full.csv']
    ...
    # print(dataset_paths, dataset, last_separator, root, glob, os.sep, 'main')
